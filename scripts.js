    jQuery(document).ready(function(){
        jQuery('#qt_import_start').click(qt_import_process_batch);
        ...
        function qt_import_process_batch(){
            ...
            jQuery.ajax({
                ...
                url: ajaxurl,
                dataType: 'json',
                data: 'action=qt_import_ajx&qt_import_batch='+qt_import_batch+'&qt_keepgoing='+qt_keepgoing,
        ...
        function qt_fix_links(){
            ...
            jQuery.ajax({
                ...
                url: ajaxurl,
                dataType: 'json',
                data: 'action=qt_fix_links_ajx&qt_lfix_batch='+qt_lfix_batch+'&qt_keepgoing='+qt_keepgoing,
                success: function(res){                            
                    jQuery('#qt_import_status').html(res.messages.join('<br />') + jQuery('#qt_import_status').html());
                    if(res.keepgoing){
                        qt_keepgoing = 1;
